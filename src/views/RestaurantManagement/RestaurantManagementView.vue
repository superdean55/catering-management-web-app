<template>
    ...
    <div class="h-10"></div>
        <div class="w-40 fixed z-40">
            <div :class="['fixed w-48 transition-transform duration-300', 
                ...
                <nav :class="{
                    ...
                    <ul>
                        ...
                        <li class="bg-orange-700 hover:bg-orange-800 text-white">
                            <RouterLink :to="{ name: 'PayDeskDashboard' }" class="flex items-center justify-center h-10 w-full" @click="changeHamburgerVisibiliti">Blagajna</RouterLink>
                        </li>
                        <li><div class="h-px w-full bg-gray-500"></div></li>
                        <li class="bg-orange-700 hover:bg-orange-800 text-white">
                            <RouterLink :to="{ name: 'AddNewEmployeeView' }" class="flex items-center justify-center h-10 w-full" @click="changeHamburgerVisibiliti">Zaposlenici</RouterLink>
                        </li>
                        <li><div class="h-px w-full bg-gray-500"></div></li>
                        <li class="bg-orange-700 hover:bg-orange-800 text-white">
                            <RouterLink :to="{ name: 'TablesView' }" class="flex items-center justify-center h-10 w-full" @click="changeHamburgerVisibiliti">Stolovi</RouterLink>
                        </li>
                        <li><div class="h-px w-full bg-gray-500"></div></li>
                    </ul>
                </nav>
        ...
        <div class="w-full flex flex-row gap-2" :style="{justifyContent: screenStore.isSmallScreen ? 'flex-end' : 'flex-start'}">
            <RouterView name="management" class="" :class="screenStore.isSmallScreen ? '' : 'pl-48'"></RouterView>
        </div>
  </main>
</template>
